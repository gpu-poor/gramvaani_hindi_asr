...
inference_nj=15      # The number of parallel jobs in decoding.
gpu_inference=true #false  # Whether to perform gpu decoding.
...
lang=ie      # The language type of corpus.
train_set=tr_${lang}      # Name of training set.
valid_set=dt_${lang}       # Name of validation set used for monitoring/tuning network training.
test_sets="dt_${lang} et_${lang}"       # Names of test sets. Multiple items (e.g., both dev and eval sets) can be specified.
